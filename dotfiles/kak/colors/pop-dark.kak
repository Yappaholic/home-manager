...
# kakoune-lsp
set-face global DiagnosticError "%opt{redE}"
set-face global DiagnosticHint "%opt{yellowH}"
set-face global DiagnosticInfo "%opt{yellowH}"
set-face global DiagnosticWarning "%opt{orangeW}"
set-face global InlayHint "%opt{brownD},%opt{brownU}"
set-face global LineFlagError "%opt{redE}+b"
set-face global LineFlagHint "%opt{yellowH}+b"
set-face global LineFlagInfo "%opt{brownD}"
set-face global LineFlagWarning "%opt{orangeW}+b"
set-face global Reference "black,%opt{blueD}"