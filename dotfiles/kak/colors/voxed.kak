...
# kakoune-lsp
set-face global DiagnosticError "%opt{bpink}"
set-face global DiagnosticHint "%opt{maize}"
set-face global DiagnosticInfo "%opt{sglow}"
set-face global DiagnosticWarning "%opt{redish}"
set-face global LineFlagError "%opt{bsienna}"
set-face global LineFlagHint "%opt{tan}"
set-face global LineFlagInfo "%opt{maize}"
set-face global LineFlagWarning "%opt{bpink}"
set-face global Reference "rgb:212121,rgb:6C6999"