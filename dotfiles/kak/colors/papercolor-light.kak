...
set-face global ts_comment "%opt{regular5}+i"
set-face global ts_comment_block "%opt{regular5}+i"
set-face global ts_comment_line "%opt{regular5}+i"
...
# kakoune-lsp
set-face global DiagnosticError "%opt{bright1}"
set-face global DiagnosticHint "%opt{bright6}"
set-face global DiagnosticInfo "%opt{bright4}"
set-face global DiagnosticWarning "%opt{bright0}%opt{bright5}+d"
set-face global InlayHint "%opt{regular5}+i"
set-face global LineFlagError "%opt{error_fg},%opt{error_bg}"
set-face global LineFlagInfo "%opt{todo_fg}"
set-face global LineFlagWarning "%opt{bright5}"
set-face global Reference "%opt{matchparen_fg},%opt{matchparen_bg}"