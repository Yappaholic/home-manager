...
# kakoune-lsp
set-face global DiagnosticError "%opt{ferra_ember}"
set-face global DiagnosticHint "%opt{ferra_blush}"
set-face global DiagnosticInfo "%opt{ferra_blush}"
set-face global DiagnosticWarning "%opt{ferra_honey}"
set-face global InlayHint "%opt{ferra_bark}"
set-face global LineFlagError "%opt{ferra_ember}"
set-face global LineFlagHint "%opt{ferra_blush}"
set-face global LineFlagInfo "%opt{ferra_blush}"
set-face global LineFlagWarning "%opt{ferra_honey}"
set-face global Reference "%opt{ferra_night},%opt{ferra_bark}"