...
set-face global DiagnosticHint "%opt{grey05}"
set-face global DiagnosticInfo "%opt{grey05}"
set-face global DiagnosticWarning "%opt{orange}"
set-face global InlayHint "%opt{grey03}+i"
set-face global LineFlagError "red"
set-face global LineFlagHint "%opt{grey05}"
set-face global LineFlagInfo "%opt{grey05}"
set-face global LineFlagWarning "%opt{orange}"
set-face global Reference "bright-white+u"