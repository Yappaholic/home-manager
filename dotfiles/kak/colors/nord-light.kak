...
# kakoune-lsp
set-face global DiagnosticError "%opt{nord11}"
set-face global DiagnosticHint "%opt{nord13}"
set-face global DiagnosticInfo "%opt{nord13}"
set-face global DiagnosticWarning "%opt{nord13}"
set-face global InlayHint "%opt{nord3}+i"
set-face global Reference ",%opt{nord8}"