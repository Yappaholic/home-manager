...
set-face global DiagnosticHint "%opt{base8}"
set-face global DiagnosticInfo "%opt{base8}"
set-face global DiagnosticWarning "%opt{orange}"
set-face global InlayHint "%opt{base6}"
set-face global LineFlagError "red+b"
set-face global LineFlagHint "%opt{base8}"
set-face global LineFlagInfo "%opt{base8}"
set-face global LineFlagWarning "%opt{orange}"
set-face global Reference ",%opt{base4}"