...
set-face global DiagnosticWarning "%opt{warn}"
set-face global InlayHint "%opt{gray1}"
set-face global LineFlagError "%opt{error}"
set-face global LineFlagHint "%opt{hint}"
set-face global LineFlagInfo "%opt{info}"
set-face global LineFlagWarning "%opt{warn}"
set-face global Reference "%opt{bg1},%opt{ultramarine4_dark}"