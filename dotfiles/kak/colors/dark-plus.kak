...
set-face global InlayHint "%opt{dark_gray5}"
set-face global LineFlagError "red"
set-face global LineFlagHint "%opt{light_gray3}"
set-face global LineFlagInfo "%opt{light_blue}"
set-face global LineFlagWarning "%opt{gold2}"
set-face global Reference ",rgb:3A3D41"