...
# kakoune-lsp
set-face global DiagnosticError "%opt{my_red}"
set-face global DiagnosticHint ",%opt{my_black},%opt{my_gray5}"
set-face global DiagnosticInfo ""
set-face global DiagnosticWarning "%opt{my_yellow2}"
set-face global InlayHint "%opt{my_gray4},%opt{my_black}"
set-face global LineFlagError "%opt{my_red}"
set-face global LineFlagHint "%opt{my_gray6}"
set-face global LineFlagInfo "%opt{my_yellow2}"
set-face global LineFlagWarning "%opt{my_yellow2}"
set-face global Reference "%opt{my_white1},%opt{my_black},%opt{my_white1}+b"