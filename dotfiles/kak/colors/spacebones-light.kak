...
# kakoune-lsp
set-face global DiagnosticError "rgb:E0211D"
set-face global DiagnosticHint "%opt{bg2}"
set-face global DiagnosticInfo "%opt{theme_yellow}"
set-face global DiagnosticWarning "%opt{meta}"
set-face global LineFlagError "rgb:E0211D"
set-face global LineFlagHint "%opt{bg2}"
set-face global LineFlagInfo "%opt{theme_yellow}"
set-face global LineFlagWarning "%opt{meta}"
set-face global Reference ",%opt{bg3}"