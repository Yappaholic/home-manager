...
# kakoune-lsp
set-face global DiagnosticError "%opt{bogster_lred}"
set-face global DiagnosticHint "%opt{bogster_blue}"
set-face global DiagnosticInfo "%opt{bogster_teal}"
set-face global DiagnosticWarning "%opt{bogster_orange}"
set-face global LineFlagError "%opt{bogster_lred}"
set-face global LineFlagHint "%opt{bogster_blue}"
set-face global LineFlagInfo "%opt{bogster_teal}"
set-face global LineFlagWarning "%opt{bogster_orange}"
set-face global Reference "%opt{bogster_base2},%opt{bogster_orange}"