...
set-face global DiagnosticInfo "green"
set-face global DiagnosticWarning "yellow"
set-face global InlayHint "%opt{grey_dim}"
set-face global LineFlagError "red,%opt{bg2}+b"
set-face global LineFlagHint "blue,%opt{bg2}+b"
set-face global LineFlagInfo "green,%opt{bg2}"
set-face global LineFlagWarning "yellow,%opt{bg2}+b"
set-face global Reference ",%opt{bg4}"