...
set-face global Default ",%opt{amber_shadow}@Default"
...
set-face global ts_markup_raw "%opt{misty_white}"
...
# kakoune-lsp
set-face global DiagnosticError "%opt{misty_white},%opt{rustic_red}"
set-face global DiagnosticHint "%opt{amber_shadow},%opt{walnut_brown}"
set-face global DiagnosticInfo "%opt{misty_white},%opt{twilight_slate}"
set-face global DiagnosticWarning "%opt{misty_white},%opt{rustic_amber}"
...
set-face global Reference "%opt{amber_shadow},%opt{blaze_orange}+b"