...
# kak-tree-sitter
set-face global ts_comment "%opt{teddy_bear_pink}+Bi"
...
# kakoune-lsp
set-face global DiagnosticError "%opt{chili_powder_red}"
set-face global DiagnosticHint "%opt{chili_powder_red}"
set-face global DiagnosticInfo "%opt{crystal_blue}"
set-face global DiagnosticWarning "%opt{vapor_yellow}"
set-face global LineFlagError "%opt{chili_powder_red}+b"
set-face global LineFlagHint "%opt{crystal_blue}+b"
set-face global LineFlagInfo "%opt{crystal_blue}+b"
set-face global LineFlagWarning "%opt{vapor_yellow}"
set-face global Reference "%opt{hazmat_yellow}"