...
set-face global DiagnosticHint "%opt{base03}"
set-face global DiagnosticInfo "%opt{base0D}"
set-face global DiagnosticWarning "%opt{base09}"
set-face global LineFlagError "%opt{base08}"
set-face global LineFlagHint "%opt{base03}"
set-face global LineFlagInfo "%opt{base0D}"
set-face global LineFlagWarning "%opt{base09}"
set-face global Reference "%opt{base0A}+u"