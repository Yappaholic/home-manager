...
# kakoune-lsp
set-face global DiagnosticError "%opt{red3}"
set-face global DiagnosticHint "%opt{blue0}"
set-face global DiagnosticInfo "%opt{aqua1}"
set-face global DiagnosticWarning "%opt{orange1}"
set-face global InlayHint "%opt{bg7}"
set-face global LineFlagError "%opt{red0}+b"
set-face global LineFlagHint "%opt{blue0}+b"
set-face global LineFlagInfo "%opt{aqua1}+b"
set-face global LineFlagWarning "%opt{orange1}+b"
set-face global Reference ",%opt{yellow1}"