...
# kakoune-lsp
set-face global DiagnosticError "%opt{orange1}"
set-face global DiagnosticHint "%opt{white0}"
set-face global DiagnosticInfo "%opt{blue0}"
set-face global DiagnosticWarning "%opt{green1}"
set-face global InlayHint "%opt{blue0}"
set-face global LineFlagError "%opt{orange1}"
set-face global LineFlagHint "%opt{white0}"
set-face global LineFlagInfo "%opt{blue0}"
set-face global LineFlagWarning "%opt{green1}"
set-face global Reference "%opt{pink4},%opt{pink0}"