...
# kakoune-lsp
set-face global DiagnosticError "%opt{text},%opt{error}+b"
set-face global DiagnosticHint ",cyan+b"
set-face global DiagnosticWarning "%opt{text},%opt{warning}+b"
set-face global Reference ",cyan"