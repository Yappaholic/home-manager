...
# kakoune-lsp
set-face global DiagnosticError "%opt{diff_delete}"
set-face global DiagnosticInfo "%opt{orange_text}"
set-face global DiagnosticWarning "%opt{orange_text}"
set-face global InlayHint "%opt{base4}"
set-face global LineFlagError "%opt{diff_delete}"
set-face global LineFlagHint "+b"
set-face global LineFlagInfo "%opt{orange_text},%opt{orange_bg}"
set-face global LineFlagWarning "%opt{orange_text},%opt{orange_bg}"
set-face global Reference "%opt{base5},%opt{base3}"