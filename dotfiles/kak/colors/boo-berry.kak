...
# kakoune-lsp
set-face global DiagnosticError "%opt{gold}"
set-face global DiagnosticHint "%opt{lilac}"
set-face global DiagnosticInfo "%opt{lilac}"
set-face global DiagnosticWarning "%opt{bubblegum}"
set-face global InlayHint "%opt{berry_desaturated}"
set-face global LineFlagError "%opt{bubblegum}"
set-face global LineFlagHint "%opt{lilac}"
set-face global LineFlagInfo "%opt{lilac}"
set-face global LineFlagWarning "%opt{gold}"
set-face global Reference "%opt{berry},%opt{berry_desaturated}"