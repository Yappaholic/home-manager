...
# kakoune-lsp
set-face global DiagnosticError "%opt{hotRed}"
set-face global DiagnosticHint "%opt{lowerMint}"
set-face global DiagnosticInfo "%opt{lightBlue}"
set-face global DiagnosticWarning "%opt{brightYellow}"
