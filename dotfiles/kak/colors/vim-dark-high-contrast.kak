...
# kakoune-lsp
set-face global DiagnosticError ",%opt{dark_red}"
set-face global DiagnosticHint ",%opt{dark_cyan}"
set-face global DiagnosticInfo ",%opt{dark_white}"
set-face global DiagnosticWarning ",%opt{dark_yellow}"
set-face global LineFlagError "red,%opt{dark_red}"
set-face global LineFlagHint "cyan,%opt{dark_cyan}"
set-face global LineFlagInfo "default,%opt{dark_white}"
set-face global LineFlagWarning "yellow,%opt{dark_yellow}"
set-face global Reference "bright-cyan,%opt{dark_cyan}"